          2010:[4315,2150.76,6018.28,2324.8,1940.94,5458.22,2348.54,3637.2,5741.03,10606.85,8003.67,3519.72,4467.55,2450.48,10275.5,6035.48,4212.82,4151.54,13502.42,2523.73,642.73,2232.86,4725.01,1243.43,2312.82,162.04,2253.39,1232.03,340.65,377.16,1612.6]
        });
        ...
        dataMap.dataTI = dataFormatter({
          ...
          2011:[3435.95,1150.81,2439.68,1176.65,1000.79,2487.85,1075.48,1467.9,3404.19,4493.31,3890.79,1638.42,1949.91,1043.08,4112.43,2358.86,2011.08,1995.78,7178.94,1178.25,293.85,1081.35,2189.68,558.28,1013.76,96.76,1063.89,589.91,169.81,195.46,753.91],
        ...
        const option = {
          baseOption: {
            ...
            legend: {
              ...
              y: 'top',
              orient: 'vertical',
              data: ['畅越冰激凌', '承诺低消', '传统套餐', '腾讯王卡', '冰神卡', '蚂蚁宝卡'],
              selected: {
                '腾讯王卡': false, '冰神卡': false, '蚂蚁宝卡': false
              }
            },
            calculable : true,
            grid: {
          ...
          options: [
            {
              ...
              series: [
                ...
                {data: [
                    {name: '畅越冰激凌', value: dataMap.dataPI['2010sum']},
                    {name: '承诺低消', value: dataMap.dataSI['2010sum']},
                    {name: '传统套餐', value: dataMap.dataTI['2010sum']}
                  ]}
              ]
            },
            {
              title : {text: '2011全国销售数据'},
              series : [
                ...
                {data: [
                    {name: '畅越冰激凌', value: dataMap.dataPI['2011sum']},
                    {name: '承诺低消', value: dataMap.dataSI['2011sum']},
                    {name: '传统套餐', value: dataMap.dataTI['2011sum']}
                  ]}
              ]
            },
            {
              title : {text: '2012全国销售数据'},
              series : [
                ...
                {data: [
                    {name: '畅越冰激凌', value: dataMap.dataPI['2012sum']},
                    {name: '承诺低消', value: dataMap.dataSI['2012sum']},
                    {name: '传统套餐', value: dataMap.dataTI['2012sum']}
                  ]}
              ]
            },
            {
              title : {text: '2013全国销售数据'},
              series : [
                ...
                {data: [
                    {name: '畅越冰激凌', value: dataMap.dataPI['2013sum']},
                    {name: '承诺低消', value: dataMap.dataSI['2013sum']},
                    {name: '传统套餐', value: dataMap.dataTI['2013sum']}
                  ]}
              ]
            },
            {
              title : {text: '2014全国销售数据'},
              series : [
                ...
                {data: [
                    {name: '畅越冰激凌', value: dataMap.dataPI['2014sum']},
                    {name: '承诺低消', value: dataMap.dataSI['2014sum']},
                    {name: '传统套餐', value: dataMap.dataTI['2014sum']}
                  ]}
              ]
            },
            {
              title : {text: '2015全国销售数据'},
              series : [
